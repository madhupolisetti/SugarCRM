    ...
    array (
      ...
      array (
        ...
        array (
		  ...
		  5 => array (
            'customCode' => '<input title="Send SMS" accessKey="" type="button" class="button" onClick="document.location=\'index.php?module=smsad_SMS&action=EditView&record={$fields.id.value}&return_module=Accounts&return_action=index&phone={$fields.phone_work.value}&firstname={$fields.first_name.value}\'" name="convert" value="Send SMS">',
            'sugar_html' => 
            array (
              'type' => 'button',
              'value' => 'Send SMS',
