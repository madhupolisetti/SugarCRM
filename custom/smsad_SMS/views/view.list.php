...
class smsad_SMSViewList extends ViewList
{
    ...
    public function preDisplay()
    {
		...
		echo '<input type="hidden" name="send_text1" id="send_text1" >';
		echo '<script type="text/javascript">
		<!--
		 var txts ="<div><p>From: '.$dropdown.'</p><p>Language Translation: <input type=\'checkbox\' id=\'chktranslator\' name=\'chktranslator\' value=\'1\' onclick=\'chktranslatorclick();\'></p><p>Language: <select id=\'msgtype_list\' disabled=\'disabled\' onchange =\'msgtype_listchange();\'><option value=\'en\'>English</option><option value=\'te\'>Telugu</option><option value=\'hi\'>Hindi</option><option value=\'ta\'>Tamil</option><option value=\'kn\'>Kannada</option><option value=\'ml\'>Malayalam</option><option value=\'mr\'>Marathi</option><option value=\'or\'>Oriya</option><option value=\'pa\'>Punjabi</option><option value=\'ur\'>Urdu</option><option value=\'sa\'>Sanskrit</option><option value=\'gu\'>Gujarati</option><option value=\'bn\'>Bengali</option><option value=\'ar\'>Arabic</option><option value=\'zh\'>Chinese</option><option value=\'el\'>Greek</option><option value=\'ne\'>Nepali</option><option value=\'fa\'>Persian</option><option value=\'ru\'>Russian</option><option value=\'sr\'>Serbian</option><option value=\'si\'>Sinhalese</option></select></p>Message: <textarea name=\'send_text\' id=\'send_text\' rows=\'5\' cols=\'20\' onkeyup=\'updateCount()\' onkeydown=\'updateCount()\'></textarea><span id=\'counter\'>0/160<span></div><input type=\'submit\' value=\'Send\' onclick=\'clicke()\'> ";
